...
gl_render_window_t* gl_init_context(gl_render_window_t *share) {
    EGLint egl_attributes[] = { EGL_BLUE_SIZE, 8, EGL_GREEN_SIZE, 8, EGL_RED_SIZE, 8, EGL_ALPHA_SIZE, 8, EGL_DEPTH_SIZE, 24, EGL_ALPHA_MASK_SIZE, 8, EGL_SURFACE_TYPE, EGL_WINDOW_BIT|EGL_PBUFFER_BIT, EGL_CONFORMANT, EGL_OPENGL_ES3_BIT, EGL_RENDERABLE_TYPE, EGL_OPENGL_ES3_BIT, EGL_NONE };    gl_render_window_t* bundle = malloc(sizeof(gl_render_window_t));
    ...
    int libgl_es = (long)strtol(getenv("LIBGL_ES"), NULL, 0);
